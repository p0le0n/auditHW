...
Logger::Logger(int pid)
    : pid(pid), logFile("audit.log", std::ios_base::app)
{
}

void Logger::log(unsigned long long code)
{
    this->logFile << '[' << this->pid << "] " << this->getCurrentDatetime() << " - " << Logger::syscall_names[code] << '(' << code << ')' << std::endl;
}

void Logger::log(const char* data)
{
    this->logFile << '[' << this->pid << "] " << this->getCurrentDatetime() << " - " << data << std::endl;
}
